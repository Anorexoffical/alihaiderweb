...
} from "./chunk-Q3FDEWTB.js";
import "./chunk-KOVMQDSO.js";
import {
  require_jsx_runtime
...
var Reveal = (props) => {
  ...
  return jsx2(Fragment2, { children: import_react3.Children.map(children, (node, index) => {
      ...
      case "ul":
        return jsx2(ClassNames, { children: ({ cx }) => jsx2(
          node.type,
          {
            ...
            children: jsx2(Reveal, { ...props, children: node.props.children })
          }
        ) });
      case "li":
        return jsx2(
  ...
  return matchIf(
    () => jsx2(
      "div",
      {
        ...
        children: children.split("").map((char, index) => jsx2(
          "span",
          {
            css: matchIfOrNull(() => animationStyles)(inView),
            style: {
...
var Roll = (props) => {
  ...
  const keyframes2 = (0, import_react3.useMemo)(() => getStyles$3(reverse), [reverse]);
  return jsx2(Reveal, { keyframes: keyframes2, ...rest });
};
